...
import com.examples.youtubeapidemo.helper.DeveloperKey;
import com.examples.youtubeapidemo.R;
import com.examples.youtubeapidemo.helper.RestInterface;
import com.examples.youtubeapidemo.helper.ServiceGenerator;
import com.examples.youtubeapidemo.pojo.Item;
import com.examples.youtubeapidemo.pojo.PlaylistResponse;

//import com.google.api.client.googleapis.extensions.android.gms.auth.GoogleAccountCredential;

import com.examples.youtubeapidemo.pojo.Snippet;
...
public final class VideoListDemoActivity extends FragmentActivity implements OnFullscreenListener {
  ...
  private String contentType = "snippet,contentDetails,statistics,status";
  private String accessKey = "AIzaSyBEWKxhqWb03BF40lkZhWj8IGghPhR_uM0";
  ...
  private void getVideoList() {
    ...
    String key_value ="3b12383b4c2a228211955d56170ce0f5";
    Observable<PlaylistResponse> call = service.getVideoIds(key_value);

    Subscription subscription = call
            .subscribeOn(Schedulers.io()) // optional if you do not wish to override the default behavior
            .observeOn(AndroidSchedulers.mainThread())
            .subscribe(new Subscriber<PlaylistResponse>() {
              @Override
...
//                }
              ...
              public void onNext(PlaylistResponse response) {
                  getVideoDetails(response.getData());
              }
            });
  }
